...
class LitNonLexicalLabelerTask(pl.LightningModule):
    ...
    def predict_step(self, batch, batch_idx):
        ...
        input_feature = self.get_melspec(waveform)  # [B, C, T]
        with torch.no_grad():
    ...
    def training_step(self, batch, batch_idx):
        try:
            ...
            losses = self._get_loss(cvnt_logits, input_feature_lengths, masked_non_speech_target)
    ...
    def validation_step(self, batch, batch_idx, dataloader_idx=0):
        ...
        if dataloader_idx == 0:
            losses = self._get_loss(cvnt_logits, input_feature_lengths, non_speech_target)

...
class AlignmentDecoder:
    ...
    def decode(self,
        ...
        self.T, vocab_size = ph_frame_pred.shape
...
class NonLexicalDecoder:
    ...
    def non_lexical_words(self, prob, threshold=0.5, max_gap=5, mix_frames=10, tag=""):
        ...
        :param mix_frames: minimum breathing frames
